      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-4">
            {"AREFIN AHMED".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400">Graduated in Computer Science & Engineering</div>
          <div className="text-blue-400"> AI and Machine Learning Enthusiast | 
