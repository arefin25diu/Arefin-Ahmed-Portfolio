  ...
  const experiences = [
    {
      ...
      desc: [
        "Conducted market research to identify potential partnerships.",
        "Supported outreach and communication with external organizations.",
        "Analyzed stakeholder feedback and project performance data."
      ],
    ...
    },
    {
      ...
      desc: [
        ...
        "Assisted in organizing technical workshops and seminars.",
        "Participated in hands-on sessions related to AI and data analysis."
      ],
...

    {
      ...
      desc: [
        "Assisted in organizing the Hult Prize competition at DIU.",
        "Collaborated with team members on planning and coordination.",
        "Supported execution of events and participant management."
      ],
