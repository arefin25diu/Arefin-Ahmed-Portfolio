      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "arefinrafi27@gmail.com", href: "mailto:arefinrafi27@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+88 01883-071173", href: "tel:+8801883071173", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub", href: "https://github.com/arefin25diu", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/arefin-ahmed-4594a81a0/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2025 Arefin Ahmed. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
