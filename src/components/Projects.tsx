...
export function Projects() {
  ...
  const projects = [
    {
      title: "Marine Waste Detection & Tracking System",
      image: marineImg,
      description:
      ...
      icon: Leaf,
      tech: ["Python","YOLOvX","Deep Learning","Computer Vision","DeepSORT", "OpenCV","Streamlit"],
    ...
    },
    {
      ...
      github: "https://github.com/arefin25diu/Diabetes-Prediction-",
          ...
          {
      title: "RukheDeo - Women Safety App",
      image: womenImg,
      description:
      ...
      github: "https://github.com/arefin25diu/Women-Safety-App",
        ...
        {
      title: "ShopeVerse - Online Shopping Platform",
      image: shopImg,
      description:
...
,
    ...
    {
      title: "SafeText - Vulnerable Content Detection",
      image: nlpImg,
      description:
